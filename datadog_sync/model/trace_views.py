...
class TraceViews(BaseResource):
    resource_type = "trace_views"
    ...
    # Additional TraceViews specific attributes

    def get_resources(self, client: CustomClient) -> List[Dict]:
        resp = client.get(self.resource_config.base_path + "?type=trace").json()
